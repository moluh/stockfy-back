...
export class MODELMOVIMIENTOS1638415689862 implements MigrationInterface {
    name = 'MODELMOVIMIENTOS1638415689862'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `productos` CHANGE `alto` `alto` int NULL");
        await queryRunner.query("ALTER TABLE `productos` CHANGE `ancho` `ancho` int NULL");
        await queryRunner.query("ALTER TABLE `productos` CHANGE `profundidad` `profundidad` int NULL");
        await queryRunner.query("ALTER TABLE `productos` CHANGE `peso` `peso` int NULL");
        ...
        await queryRunner.query("ALTER TABLE `productos` CHANGE `rebaja` `rebaja` int NULL");
        ...
        await queryRunner.query("ALTER TABLE `permisos` CHANGE `moduloId` `moduloId` int NULL");
        ...
        await queryRunner.query("ALTER TABLE `modulos` CHANGE `roleId` `roleId` int NULL");
        ...
        await queryRunner.query("ALTER TABLE `movimientos` DROP COLUMN `estado`");
        await queryRunner.query("ALTER TABLE `movimientos` ADD `estado` varchar(15) NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `movimientos` DROP COLUMN `estado`");
        await queryRunner.query("ALTER TABLE `movimientos` ADD `estado` char(1) NULL DEFAULT 'NULL'");
        ...
        await queryRunner.query("ALTER TABLE `modulos` CHANGE `roleId` `roleId` int NULL DEFAULT 'NULL'");
        await queryRunner.query("ALTER TABLE `modulos` ADD CONSTRAINT `FK_7bf96be87d7fc026a167090eb1e` FOREIGN KEY (`roleId`) REFERENCES `modulos`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        ...
        await queryRunner.query("ALTER TABLE `permisos` CHANGE `moduloId` `moduloId` int NULL DEFAULT 'NULL'");
        await queryRunner.query("ALTER TABLE `permisos` ADD CONSTRAINT `FK_fd7ba23e8563f6d5b5c3e7db737` FOREIGN KEY (`moduloId`) REFERENCES `modulos`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        ...
        await queryRunner.query("ALTER TABLE `productos` CHANGE `rebaja` `rebaja` int NULL DEFAULT 'NULL'");
        ...
        await queryRunner.query("ALTER TABLE `productos` CHANGE `peso` `peso` int NULL DEFAULT 'NULL'");
        await queryRunner.query("ALTER TABLE `productos` CHANGE `profundidad` `profundidad` int NULL DEFAULT 'NULL'");
        await queryRunner.query("ALTER TABLE `productos` CHANGE `ancho` `ancho` int NULL DEFAULT 'NULL'");
        await queryRunner.query("ALTER TABLE `productos` CHANGE `alto` `alto` int NULL DEFAULT 'NULL'");
        await queryRunner.query("ALTER TABLE `productos` ADD CONSTRAINT `FK_4f743618aa4b678c40b0f626391` FOREIGN KEY (`marcaId`) REFERENCES `marcas`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `productos` ADD CONSTRAINT `FK_9f09bb7988802f18e97727f046a` FOREIGN KEY (`proveedorId`) REFERENCES `proveedores`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
