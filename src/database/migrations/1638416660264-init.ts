...
export class init1638416660264 implements MigrationInterface {
    name = 'init1638416660264'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `permisos` (`id` int NOT NULL AUTO_INCREMENT, `permiso` varchar(150) NOT NULL, `activo` tinyint NOT NULL DEFAULT 1, `moduloId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `modulos` (`id` int NOT NULL AUTO_INCREMENT, `modulo` varchar(150) NOT NULL, `activo` tinyint NOT NULL DEFAULT 1, `roleId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
